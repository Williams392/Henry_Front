...
function cacheFunction(cb) {
  ...
  return function(arg) {
    ...
    // si el resultado de la operación ya está en la memoria "cache", lo retorno de ahí correctamente;
    // si no está, lo voy a calcular por primera vez, almacenar en la "cache", y retornalo
...
var squareCache = cacheFunction(sqare)
